...
Vista principal de la TUI: dashboard de tres paneles (EN VIVO / PRÓXIMOS / FINALIZADOS) según la pantalla "World Cup TUI Dashboard" de Stitch, con navegación por teclado y carga incremental de resultados anteriores.
